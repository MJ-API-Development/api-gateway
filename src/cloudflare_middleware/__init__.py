...
route_regexes = {"all_general_fundamentals": "^/api/v1/fundamental/general$/",
                 ...
                 "get_exchange_by_code": "^/api/v1/exchange/code/[a-zA-Z0-9]{16}+(?<!/)$",
                 "get_exchange_by_id": "^/api/v1/exchange/id/[a-zA-Z0-9]{16}+(?<!/)$",
                 "get_exchange_with_tickers_by_code": "^/api/v1/exchange/exchange-with-tickers/code/[a-zA-Z0-9]{16}+(?<!/)$",
                 "get_insider_transactions_from_exchange": "^/api/v1/fundamentals/ex-technical-indicators/exchange-code/[a-zA-Z0-9]{16}/\\d{4}+(?<!/)$",
                 "get_news": "^/api/v1/news/article/[a-zA-Z0-9]{16}+(?<!/)$",
                 ...
                 "get_news_articles_by_publisher": "^/api/v1/news/articles-by-publisher/[a-zA-Z0-9_-]+(?<!/)$",
                 ...
                 "get_update_delete_by_fundamental_id_company_details": "^/api/v1/fundamentals/company-details/id/[a-zA-Z0-9_-]+(?<!/)$",
                 "get_update_delete_by_id_highlights": "^/api/v1/fundamentals/highlights/id/[a-zA-Z0-9_-]+(?<!/)$",
                 "get_update_delete_by_id_postal_address": "^/api/v1/fundamentals/company-address/id/[a-zA-Z0-9_-]+(?<!/)$",
                 ...
                 "get_valuations_for_companies_listed_in_exchange": "^/api/v1/fundamentals/exchange-valuations/exchange-code/[a-zA-Z0-9_-]+/\d{4}+(?<!/)$",
                 "income_statement_by_filing_date_and_stock_code": "^/api/v1/fundamentals/financial-statements/filing-date-ticker/[a-zA-Z0-9_-]/>[a-zA-Z0-9_-]+(?<!/)$",
                 "income_statement_by_statement_id": "^/api/v1/fundamentals/financials/income-statements/[a-zA-Z0-9_-]+(?<!/)$",
                 "income_statements_by_ticker_and_date_range": "^/api/v1/fundamentals/financial-statements/ticker-date-range/[a-zA-Z0-9_-]/a-zA-Z0-9_-]/[a-zA-Z0-9_-]+(?<!/)$",
                 "most_trending_sentiment_by_stock": "^/api/v1/sentiment/trending/stock/[a-zA-Z0-9_-]+(?<!/)$",
                 "stock_trend_setters": "^/api/v1/sentiment/trend-setters/stock/[a-zA-Z0-9_-]+(?<!/)$",
                 "stock_tweet_sentiments": "^/api/v1/sentiment/tweet/stock/[a-zA-Z0-9_-]+(?<!/)$",
                 "open_api": "^/open-api$"}
