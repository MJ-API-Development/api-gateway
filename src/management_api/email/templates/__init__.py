...
class EmailTemplate:
    ...
    async def subscription_welcome(client_name, plan_name):
        template = "src/management_api/email/templates/subscription_welcome.html"
    ...
    async def payment_confirmation(client_name, plan_name, amount):
        template = "src/management_api/email/templates/payment_confirmation.html"
    ...
    async def account_confirmation(client_name: str, verification_link: str):
        template = "src/management_api/email/templates/account_confirmation.html"
